...
public class CanvasControl extends Region {
    ...
    public CanvasControl(final String text, final Image image) {
        if (null == image || image.getWidth() != image.getHeight()) {
            this.particleImg = new Image(CanvasControl.class.getResourceAsStream("style/bubbles.png"));
        } else {
    ...
    @Override public String getUserAgentStylesheet() {
        if (null == userAgentStyleSheet) { userAgentStyleSheet = CanvasControl.class.getResource("style/canvas_6.css").toExternalForm(); }
